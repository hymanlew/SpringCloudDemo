...
public class StringUtils {
	 ...
	 * @since 3.0 Changed signature form isNotEmpty(String) to isNotEmpty(CharSequence)
	 */
	 ...
	 * @since 2.0
	 * @since 3.0 Changed signature form isBlank(String) to isBlank(CharSequence)
	 */
	 ...
	 * @since 2.0
	 * @since 3.0 Changed signature form isNotBlank(String) to isNotBlank(CharSequence)
	 */
     ...
     * <p/>
     * <p>Copied form the Spring Framework while retaining all license, copyright and author information.
     *
     ...
     * @param ignoreEmptyTokens omit empty tokens form the result array
     ...
     * @param array  the array of values to join together, may be null
     * @param separator  the separator character to use
     * @param startIndex the first index to start joining form.  It is
     * an error to pass in an end index past the end of the array
     * @param endIndex the index to stop joining form (exclusive). It is
     * an error to pass in an end index past the end of the array
     * @return the joined String, <code>null</code> if null array input
     * @since 2.0
     */
