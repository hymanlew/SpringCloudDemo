...
public class HexUtils {
     ...
     * @return A byte array containing binary data decoded form
    ...
    public static byte[] decode(byte[] array) throws IllegalArgumentException {
        String s = ByteUtils.toString(array);
        return decode(s);
    }
     ...
     * @return A byte array containing binary data decoded form the supplied String's char array.
     */
